...
/*
typedef int (* GetSequenceActivityFn)( void*, int ); // CBaseAnimating::GetSequenceActivity(int sequence).
...
class IServerRenderable
{
public:
	virtual ~IServerRenderable() {};
	/*
	model_t* GetModel()
	{
...
class IServerThinkable
{
public:
	virtual ~IServerThinkable() {};
};
...
public:
	...
	{
		return (IServerNetworkable*)((uintptr_t)this + 0x10);
	}
	/*
...
public:
    ...
    CUtlVector<AnimationLayer>* GetAnimOverlay() {
        return reinterpret_cast<CUtlVector<AnimationLayer>*>((uintptr_t)this + playerAnimOverlayOffset);
    }
...
class CWeaponC4 : CBaseCombatWeapon
{
public:
